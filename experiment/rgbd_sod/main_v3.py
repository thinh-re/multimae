...
def MULTIMAE_V3(
    ...
    """
    assert len(args.decoder_main_tasks) == len(
        args.outputs
    ...
    for output_key, decoder_main_tasks_per_output in zip(
        args.outputs, args.decoder_main_tasks
    ):
    ...
    for n, p in model.named_parameters():
        if n in untrained_keys:
            opt_params.append({"params": p, "name": n, "lr_scale": args.lr_scale})
        else:
