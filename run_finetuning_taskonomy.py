...
def get_args():
    ...
    parser = argparse.ArgumentParser(
        "MultiMAE Taskonomy fine-tuning script", add_help=False
    )
    ...
    parser.add_argument(
        "--input_size", default=384, type=int, help="images input size for backbone"
    )
    parser.add_argument(
        "--drop_path_encoder",
        type=float,
    ...
    parser.add_argument(
        "--data_path",
        default=data_constants.TASKONOMY_PATH,
        type=str,
        help="dataset path",
    )
    parser.add_argument(
...
def main(args):
    ...
    dataset_train = TaskonomyDataset(
    ...
    tasks_loss_fn = {domain: DOMAIN_CONF[domain]["loss"] for domain in args.out_domains}
