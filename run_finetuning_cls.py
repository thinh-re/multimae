...
def get_args():
    ...
    parser = argparse.ArgumentParser(
        "MultiMAE fine-tuning and evaluation script for image classification",
        add_help=False,
    )
    parser.add_argument(
    ...
    parser.add_argument(
        "--no_mean_pooling", action="store_false", dest="use_mean_pooling"
    )
    ...
    parser.add_argument(
        "--data_path",
        default=os.path.join(data_constants.IMAGENET_TRAIN_PATH, "rgb"),
        type=str,
        help="dataset path",
    )
    parser.add_argument(
        "--eval_data_path",
        default=os.path.join(data_constants.IMAGENET_VAL_PATH, "rgb"),
        type=str,
